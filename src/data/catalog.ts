...
export const categories: Category[] = [
  {
    ...
    products: [
      ...
      mkProduct(
        "mixer-cases",
        "Mixer Cases",
        "Doghouse-style mixer cases for digital and analogue consoles",
        "Custom-fit cases for audio consoles with doghouse lid, work surface access and integrated cable management.",
        ["Console-specific cut", "Doghouse lid", "Cable channels", "Removable lid", "Foam-lined interior"],
        ["FOH mixing", "Studio transport", "Broadcast"],
        ["Events", "Broadcasting"],
        "Audio mixer flight case with doghouse lid",
      ),
      mkProduct(
        "speaker-cases",
        "Speaker Cases",
        "Protective covers and cases for PA, line array and monitor speakers",
        "Cases sized to your speaker models with reinforced corners, recessed handles and foam padding to absorb shock during transport.",
        ["Custom speaker fit", "Recessed handles", "Stackable corners", "Foam padding", "Optional wheels"],
        ["Concert touring", "Corporate AV", "Event rental"],
        ["Events", "Broadcasting"],
        "Speaker flight case for PA equipment",
      ),
      mkProduct(
        "tv-screen-cases",
        "TV / Screen Cases",
